      ...
      <div className="max-w-4xl mx-auto px-4 py-8">
        ...
        <section className="mb-12">
          <h2 className="text-2xl font-semibold mb-4">
            {t("initiation.sections.setup.title")}
          </h2>
          <p className="mb-4">{t("initiation.sections.setup.description")}</p>
          <div className="bg-gray-50 p-4 rounded-lg mb-4">
            <pre className="text-sm text-gray-700">
              npx create-next-app@latest portfolio-wpl
            </pre>
          </div>
        </section>
        ...
        <section className="mb-12">
          ...
          <p className="mb-4">
            The project follows a structured organization with clear separation
            of concerns:
          </p>
          <div className="bg-gray-50 p-4 rounded-lg mb-4">
            <pre className="text-sm text-gray-700">
...
└── styles/
    └── globals.css`}
        ...
        <section className="mb-12">
          ...
          <p className="mb-4">
            We implemented a complete internationalization (i18n) system
            supporting English and Dutch languages. This includes:
          </p>
          <div className="space-y-4">
            <div className="bg-white shadow-sm rounded p-4">
              ...
              <p className="text-gray-700">
                Added next-i18next, react-i18next, and i18next for translation
                support.
              </p>
            </div>
            <div className="bg-white shadow-sm rounded p-4">
              ...
              <p className="text-gray-700">
                Created next-i18next.config.js with locale settings and
                integrated it with Next.js configuration.
              </p>
            </div>
            <div className="bg-white shadow-sm rounded p-4">
              <h3 className="font-semibold mb-2">3. Translation Files</h3>
              <p className="text-gray-700">
                Organized translations in /public/locales/{"{locale}"}
            ...
            <div className="bg-white shadow-sm rounded p-4">
              ...
              <p className="text-gray-700">
                Implemented a language switcher component in the header for
        ...
        <section className="mb-12">
          ...
          <div className="bg-white shadow-sm rounded p-4">
            <ul className="list-disc list-inside space-y-2 text-gray-700">
              ...
              <li>
                Landing page with sections for blog posts and internship
                overview
              </li>
